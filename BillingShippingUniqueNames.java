...
public class BillingShippingUniqueNames {
	...
	//Entry Claim: The method receives 5 Strings (billFirstName, billLastName, shipFirstName, shipLastName, billNameOnCard).
	//Exit Claim: The method returns how many unique names are there in the transaction.
	...
	//Entry Claim: The method receives 2 Strings (name, cardName).
	//Exit Claim: returns true if name was a typo of one of the parts of the cardName String.
	...
	//Entry Claim: The method receives 2 Strings (name1, name2).
	//Exit Claim: The method returns true if name1 has a single different letter than name2 not more nor less.
